...
class wupclient:
    ...
    def __init__(self, ip='192.168.2.14', port=1337):
...
#0x0A is TEST
#0x14 is unknown
    def changeSecurityLevel(self,data):
        request = struct.pack('>I', 0x79) + data
        self.s.send(request)
        return struct.unpack(">I", data)[0]
