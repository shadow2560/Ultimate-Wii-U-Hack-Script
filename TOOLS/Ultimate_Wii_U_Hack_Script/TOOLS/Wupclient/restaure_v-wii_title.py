...
w.mkdir('/vol/storage_slccmpt01/title/00000001/' + sys.argv[2], 0x755)
...
up_folder('save_v-wii/titles/vol/storage_slccmpt01/title/00000001/' + sys.argv[2], '/vol/storage_slccmpt01/title/00000001/' + sys.argv[2])
...
do_folder('/vol/storage_slccmpt01/title/00000001/' + sys.argv[2])
